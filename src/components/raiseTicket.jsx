...
//     // Allow Institutional Admin
//     setAuthorized(true);

//     // Prefill user data to avoid manual typing
//     setForm((prev) => ({
//       ...prev,
//       name: parsed.name || "",
//       email: parsed.email || "",
...
//   // Stop UI from rendering before authorization check
//   if (!authorized) {
//     return (
//       <div className="min-h-screen flex items-center justify-center text-xl text-blue-900">
//         Checking access...
//       </div>
//     );
//   }
...
//                 value={form.name}
//                 disabled
//                 className="w-full py-2 bg-transparent outline-none cursor-not-allowed"
//               />
//             </div>
//           </div>
...
//           {/* Institution */}
//           <div>
//             <label className="block font-medium text-blue-800 mb-1">Institution</label>
//             <input
//               type="text"
//               name="institution"
//               value={form.institution}
//               disabled
//               className="w-full border bg-blue-50 px-3 py-2 rounded-lg outline-none cursor-not-allowed"
//             />
//           </div>
